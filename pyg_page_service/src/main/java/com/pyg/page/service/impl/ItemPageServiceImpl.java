...
public class ItemPageServiceImpl implements ItemPageService {
    ...
    public boolean getItemPageHtml(Long goodsId) {
        try {
            ...
            //3.商品分类
            String itemCat1 = "itemCat1没有查到数据";
            try {
                itemCat1 = itemCatMapper.selectByPrimaryKey(goods
                        .getCategory1Id()).getName();
            } catch (Exception e) {
            }

            String itemCat2 = "itemCat2没有查到数据";
            try {
                itemCat2 = itemCatMapper
                        .selectByPrimaryKey(goods.getCategory2Id()).getName();
            } catch (Exception e) {
            }
            String itemCat3 = "itemCat3没有查到数据";
            try {
                itemCat3 = itemCatMapper.selectByPrimaryKey(goods
