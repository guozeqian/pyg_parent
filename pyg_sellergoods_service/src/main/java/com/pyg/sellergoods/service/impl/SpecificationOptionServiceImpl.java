 ...
 */
@Service
public class SpecificationOptionServiceImpl implements
    ...
    public PageResult findPage(int pageNum, int pageSize) {
        ...
        Page<TbSpecificationOption> page = (Page<TbSpecificationOption>)
				specificationOptionMapper.selectByExample(null);
    ...
    @Override
    public PageResult findPage(TbSpecificationOption specificationOption, int
        ...
        if (specificationOption != null) {
            if (specificationOption.getOptionName() != null &&
					specificationOption.getOptionName().length() > 0) {
